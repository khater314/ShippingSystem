...
namespace DAL.Migrations
{
    ...
    [Migration("20260608165049_AddSenderAndReciverObjectsInTbShipment")]
    partial class AddSenderAndReciverObjectsInTbShipment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domains.TbPackaging", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValueSql("(newid())", "DF_TbPackagings_Id");
            ...
            modelBuilder.Entity("Domains.TbRefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValueSql("(newid())", "DF_TbRefreshTokens_Id");
            ...
            modelBuilder.Entity("Domains.TbUserContact", b =>
                {
                    ...
                    b.Property<string>("OtherAddressInfo")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domains.TbShipment", b =>
                {
                    b.HasOne("Domains.TbPackaging", "Packaging")
                    ...
                    b.HasOne("Domains.TbUserContact", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .IsRequired()
                        .HasConstraintName("FK_TbShipments_TbUserContacts_Receiver");

                    b.HasOne("Domains.TbUserContact", "Sender")
                        .WithMany("TbShipments")
